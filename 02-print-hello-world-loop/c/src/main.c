 ...
 *      Data
 ***************************************************************************/
const char *argp_program_version = "Hello_World_Loop 0.4";
...
int main(int argc, char* argv[])
{
    ...
    //"Legacy" code whose only purpose is to serve as a example, do not uncomment, as it is incompatible with ARGP parsing.
    /*
    if (argc < 2) {
        n = 100;
    }
